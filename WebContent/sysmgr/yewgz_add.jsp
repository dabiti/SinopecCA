...
>
		...
		<html:form styleId="form1" method="post"
			action="yewgzConfig.do?method=save">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="0"
							...
							<tr>
								...
								<td class="class1_td alignleft">
									<input id="yuansid" name="yuansid" type="text"
							...
							<tr>
								...
								<td class="class1_td alignleft">
									<input id="validaterule" value="${yewgz.validaterule}"
										...
										style="width: 120px;" />
								<!-- 
							        <select id="validaterule" name="validaterule" >
							...
							<tr>
								...
								<td class="class1_td alignleft">
									<html:select styleId="isreadonly" property="isreadonly"
										value="${yewgz.readonly}" style="width:120px;">
							...
							<tr>
								...
								<td class="class1_td alignleft">
									<input id="remark" name="remark" value="${yewgz.remark}"
										type="text" class="inputField" style="width: 600px;" />
								</td>
							</tr>
						</table>
					</td>
