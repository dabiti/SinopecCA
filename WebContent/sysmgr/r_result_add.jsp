...
<html>
	...
	<body onkeydown='if(event.keyCode==78&&event.ctrlKey)return false;'>
		...
		<html:form styleId="form" action="r_resultMgr.do?method=save" method="post">
					...
					<td>
						<table width="100%" border="0" cellspacing="1" cellpadding="0"
							...
							<tr>
								...
								<td class="class1_td alignleft">
									<html:text property="map(yaosbs)" maxlength="10" styleClass="inputField required BAOBBS" />
									*主键，自定义
								</td>
								<td class="class1_td alignleft"></td>
							</tr>
							...
							<tr>
								...
								<td class="class1_td alignleft">
									<html:text styleId="zhidbs" property="map(ZHIDBS)" styleClass="inputField" />
									*例如：具体参见表对应字典标识 <a href="javascript:doAddDict();">添加字典要素</a>
								<td class="class1_td alignleft"></td>
							</tr>
						</table>
					</td>
