...
>
		...
		<html:form styleId="form1" method="post"
			action="tisxxConfig.do?method=save">
							...
							<tr>
								...
								<td class="class1_td alignleft">
									<input id="msgId" name="msgId" type="text"
										value="${tisxx.msgId}" class="inputField required"
										style="width: 120px;" />
										*自定义，区分大小写，字母或数字
								</td>
							</tr>
							<tr>
								...
								<td class="class1_td alignleft">
									<input id="msgContent" name="msgContent" type="text"
										value="${tisxx.msgContent}" class="inputField2 "
										style="width: 120px;" />
										*页面展示的提示信息
								</td>
							</tr>
			...
			<div class="funbutton">
				<button type="submit" style="width: 60px" type="submit"
					onmouseover=
	this.className = 'buttom2';
onmouseout=
	this.className = 'buttom1';
class="buttom1">
