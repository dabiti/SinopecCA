...
<html>
	...
	<body onkeydown='if(event.keyCode==78&&event.ctrlKey)return false;'>
		<input id="gongnmc" type="hidden" value="中石化对账系统">
		<input id=gongnid type="hidden" value="1">	
...
<script type="text/javascript">
			var randomid = Math.floor(Math.random() * 1000000) + 1;
          	var gongnmc = document.getElementById('gongnmc').value;
          	var gongnid = document.getElementById('gongnid').value;
            ...
            webFXTreeConfig.usePersistence  = false;
		 	var tree = new WebFXLoadTree(gongnmc, 
		 	"../doMenu.do?method=loadtree&shangjgn="+gongnid+"&randomid="+randomid,
		 	"../doMenu.do?method=load&&shangjgn="+gongnid,"mainF");
		 	document.write(tree);
	  </script>
					</div>
				</td>
