...
<form id="form1" name="form1" method="post" action="pingzcs.do?method=update">
<html:form styleId="form1" action="pingzcs.do?method=update" method="post">
    ...
    <td>
      <table width="100%"  border="0" cellspacing="1" cellpadding="0" class="class1_table">
        <thead class="class1_thead">
          <tr>
            <th colspan="2" class="class1_thead th">修改系统凭证信息</th>
          </tr>
        </thead>
        <tbody>
        <tr>
