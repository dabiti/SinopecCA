...
<html:form styleId="form1" action="peizDPI.do?method=update" method="post">
    ...
    <td>
      <table width="100%"  border="0" cellspacing="1" cellpadding="0" class="class1_table">
        <thead class="class1_thead">
          <tr>
            <th colspan="2" class="class1_thead th">修改DPI配置</th>
          </tr>
        </thead>
        <tbody>
         <tr>
          <td class="class1_td w250">编号：</td>
          <td class="class1_td alignleft"><html:text styleId="dpiid" property="dpiid" styleClass="inputField "/></td>
		</tr>
	    <tr>
