  ...
  <tr>
	...
	<table width="100%"  border="0" cellspacing="1" cellpadding="0" class="class1_table">
        <thead class="class1_thead">
          <tr> 
            <th colspan="7" class="class1_thead th">节点信息列表</th>
          </tr>
          <tr>
            <td class="class1_thead th w60">序号</td>
            <td class="class1_thead th">节点标志</td>
	        <td class="class1_thead th">节点名称</td>
        ...
        <tr> 
		  ...
		  <a href="xitjd.do?method=find&jiedbs=${xitjd.jiedbs }">修改</a>　
		  <a href="javascript:if(confirm('你确定要删除所选择的节点信息吗?'))window.location.href='xitjd.do?method=delete&jiedbs=${xitjd.jiedbs }'">删除</a>　
		  </td>
        </tr>
        </c:forEach>
      </table></td>
