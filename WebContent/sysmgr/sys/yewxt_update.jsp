...
<form id="form1" name="form1" method="post" action="yewxt.do?method=update">
<html:form styleId="form1" action="yewxt.do?method=update" method="post">
    ...
    <td>
      <table width="100%"  border="0" cellspacing="1" cellpadding="0" class="class1_table">
        <thead class="class1_thead">
          <tr>
            <th colspan="2" class="class1_thead th">修改系统信息</th>
          </tr>
        </thead>
        <tbody>
        <tr>
	    ...
	    <tr>
          <td class="class1_td w250">系统名称：</td>
          <td class="class1_td alignleft"><html:text styleId="xitmc" property="xitmc" styleClass="inputField "/></td>
        </tr>
        <tr>
          <td class="class1_td w250">验证信息：</td>
          <td class="class1_td alignleft"><html:text styleId="yanzxx" property="yanzxx" styleClass="inputField "/></td>
        </tr>
        </tbody>
    </table></td>
