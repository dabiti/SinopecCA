				...
				%>
					<ec:table 
					  ...
					  filterable="false" sortable="false"
					   action="pingz.do?method=getPingzMxRizListByPich"
					  title="凭证追踪日志列表" showPagination="true" view="compact"
					  items="list"  rowsDisplayed="${ec_yemjlts}" 
					  imagePath="${pageContext.request.contextPath}/images/table/*.gif">
						...
						<ec:row>
							...
							<ec:column property="caoz" title="操作" />
						</ec:row>
					</ec:table>
				</td>
