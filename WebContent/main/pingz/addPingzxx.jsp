...
<html>
	<head>
		...
		function validata(key){
			...
			if(key==0){
				$("#pingzbsMsg").html("");
				var pingzbs=$("#pzbs").val();
				if(pingzbs==null||pingzbs.length==0){
					$("#pingzbsMsg").html("凭证标示不能为空!");
					return false;
				}
				if(pingzbs.length<=2){
					$("#pingzbsMsg").html("凭证标示格式不正确");
					return false;
				}
				$("#pingzbsMsg").html("");
				return true;
	...
	<body onkeydown='if (event.keyCode==78&& event.ctrlKey)
		...
		<form id="form1" action="yinjManage.do?method=addPingzxx" method="post"  >
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="0"
							...
							<tr>
								...
								<td class="class1_td alignleft" >
									<input type="text" name="pzbs" id="pzbs" maxlength="4" title="3位数字" class="inputField" style="width:180px" name="pingzmc" onblur="validata(0);"  onkeydown="if(event.keyCode==13){if(!validata(0)){this.focus();return false;}}" value="${pingz.pingzbs}">
									<span style="color:red">*&nbsp;</span><span style="color:red" id="pingzbsMsg"></span>
								</td>
							</tr>
							<tr>
								<td class="class1_td  alignright">
							...
							<tr>
								...
								<td class="class1_td alignleft" >
									<input type="text" id="xianssx"  class="inputField" style="width:45px" name="xianssx" onblur="validata(2);"  onkeydown="if(event.keyCode==13){if(!validata(2)){this.focus();return false;}}" value=""/><span style="color:red" id="shunxMsg"></span>
								</td>
							</tr>
