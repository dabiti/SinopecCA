...
<html:form action="accountinfo.do?method=importOldAccountinfo_excel" method="post" onsubmit="if(importExcel()){return true;}"  enctype="multipart/form-data" styleId="form1">
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0" 
						class="class1_table">
							<thead class="class1_thead">
								<tr>
									<th id="title" colspan="2" class="class1_thead th">新旧简账号导入</th>
								</tr>
							</thead>
							<tr>
