...
<html>
		...
		$(document).ready(function() {
		 ...
		 $("#form1").validate({
		   ...
		   submitHandler:function(form){
	        ...
	        if (confirm("确定要删除入库凭证信息?"))
	        {
			   var obj = new Object(); 
			   obj.titleName = "删除入库凭证信息";
			   var backNum = window.showModalDialog('shuangrhq.jsp',obj,"dialogWidth=10px;dialogHeight=10px;status=no;scroll=no"); 
			   if(backNum=='1')
			   {
				   form.submit();
				   $("#tu").html('<table align="center"><tr><td><img border="1" src="images/appInstall_animated.gif"/><b>入库信息删除中,请稍等......<b></td></tr></table>');
			   }
		    }
           </c:if>
           <c:if test='${tesyw_shuangrhq!=1}'>
	...
	<body onkeydown='if(event.keyCode==78&&event.ctrlKey)return false;' >
		...
		<html:form styleId="form1" action="zhongkpz.do?method=saveQzrk"
			method="post">
