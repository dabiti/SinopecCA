...
<html>
	<head>
		...
		<script type="text/javascript"> 
		 ...
		 $("#zhangh").focus();
		   ...
		   if (confirm("确定要保存退回信息？"))
		   {
		      form.submit();
		      $("#tu").html('<table align="center"><tr><td><img border="1" src="images/appInstall_animated.gif"/><b>退回信息录入中,请稍等......<b></td></tr></table>');
		   }
		   }
		 }) 
		 });
	...
	<body onkeydown='if(event.keyCode==78&&event.ctrlKey)return false;'>
		...
		<html:form styleId="form1" action="zhongkpz.do?method=saveTuih"
			method="post">
					...
					<td>
						<table width="100%" border="0" cellspacing="1" cellpadding="0"
							...
							<td width="45%" class="class2_td  alignright">
								...
								<td class="class2_td alignleft">
									<html:select property="tuihmode" style="width: 135px;">
							...
							<tr>
								...
								<td class="class2_td alignleft w220">
									<input name="guiyh" id="guiyh" class="inputField required guiyh" />
								</td>
							</tr>
						</table>
					</td>
			...
			<div class="funbutton">
				...
				<button type="button" style="width: 60px"
					onclick='javascript:form1.reset();document.getElementById("zhongzpzh").innerHTML="";document.getElementById("qispzh_").value="";document.getElementById("bens").value="1";document.getElementById("guiyh").value="";'
					onmouseover="this.className='buttom2'"
					onmouseout="this.className='buttom1'" class="buttom1">
