...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td background="images/main_place_bg.gif">系统管理-异步验印参数设置</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%"  border="0" style="table-layout:fixed;word-wrap:break-word;" cellspacing="1" cellpadding="0" class="class1_table">
          ...
          <tr> 
            ...
            <td class="class1_thead th">机构名称</td>
	   		<td class="class1_thead th">作业中心IP地址</td>
	   		<td class="class1_thead th">作业中心备用IP地址</td>
	        <td class="class1_thead th">作业中心端口</td>
	        <td class="class1_thead th">超时时常(单位:秒)</td>
	        <td class="class1_thead th">节点号</td>
      	...
      	<c:forEach items="${AsynSealCheckConfigList}" var="zuoyzx">
	        <tr> 
		  	 ...
		  	 <a href="javascript:window.location.href='orgManage.do?method=toModiAsynSealCheckConfig&jigh=${zuoyzx.jigh}';">修改</a>
		  	  </td>
