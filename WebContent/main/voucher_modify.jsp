...
<html>
	...
	<body onkeydown='if(event.keyCode==78&&event.ctrlKey)return false;'>
		...
		<html:form styleId="form1" action="voucherManage.do?method=updateVoucher" method="post">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="0" class="class1_table">
							...
							<tr>
								...
								<td class="class1_td alignleft">
									<bean:write name='VoucherForm' property='pingzbs' />
									<html:hidden styleId="pingzbs" property="pingzbs"/>
								</td>
							</tr>
							<tr>
								<td class="class1_td w250">
