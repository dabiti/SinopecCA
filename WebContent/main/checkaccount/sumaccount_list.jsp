	...
	<body onkeydown='if(event.keyCode==78&&event.ctrlKey)return false;'>		
			...
			<tr>
				...
				<td class="class1_td" style="text-align: left">
					<html:form styleId="form1" method="post" action="checkaccount.do?method=querySumAccount">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
...
<%--						<ec:exportXls fileName="zhanghtbrz.xls" tooltip="Export Exl" ></ec:exportXls>--%>
						...
						<ec:row >
							...
							<ec:column property="amountsum" title="交易金额" />
							<ec:column property="poundagesum" title="交易手续费"  />
