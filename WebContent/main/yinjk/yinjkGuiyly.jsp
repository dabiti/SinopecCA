...
$(function(){
	...
	<body onkeydown='if(event.keyCode==78&&event.ctrlKey)return false;'>
		...
		<html:form action="yinjkOperate.do?method=saveGuiyly" method="post"
			 styleId="form1">
					...
					<td>
						<table width="100%" border="0" cellspacing="1" cellpadding="0"
							...
							<tr>
								...
								<td width="55%" class="class2_td alignleft w220">
								<html:text property="lyClerkCode" styleId="lyClerkCode" onkeydown="if(event.keyCode==13){if(false){this.focus();return false;}}"
										onblur="if(!validate(3)){this.focus();return false;}else{checkClerk();}" maxlength="7" style="width: 160px;" ></html:text>
