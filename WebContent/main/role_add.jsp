...
<script language="javascript">
	...
	function makeJsonTree() {
		var notes = allTree.getNodes();
		var simpleTreeNodes = allTree.transformToArray(notes);
		//JSON串
		var jsonString = "[";
	...
	$(document).ready(function() {
			//全量数据 数据 生成
			allTree = $("#srcTree").zTree(allSetting, datad);
			$("#form1").validate({
	...
	<body>
		...
		<html:form styleId="form1" action="roleManager.do?method=save" method="post">
				  	...
				  	<thead class="class1_thead">
                        ...
                        <tr>
                          <td width="113"><table width="200" height="305" border="0" align="l" cellpadding="0" cellspacing="1" class="class1_table">
                            <b > <div class="class1_thead">填写角色信息</div> </b>
                            <tr>
                              <td class="class1_td w250" >角色ID</td>
                              <td class="class1_td alignleft"><html:text styleId="juesid" property="juesid"  maxlength="12" styleClass="inputField required"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td class="class1_td alignleft"><html:textarea styleId="beiz" property="beiz"   style="width:130px;height:165px" styleClass="inputField " />
                              </td>
                            </tr>
                          </table></td>
