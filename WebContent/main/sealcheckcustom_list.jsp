						...
						<tr>
							<td class="w70">
								<button type="button" style="width:60px"
									...
									onClick="location.href='sealcheckcustom.do?method=add'">
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<logic:iterate id="base" name="list" indexId="ind" type="com.unitop.sysmgr.bo.Dzcxinfo">
							<tr>
								...
								<td class="class1_td ">
										<a href="javascript:if(confirm('确定要删除？'))window.location.href='sealcheckcustom.do?method=delete&id=<bean:write name="base" property="id" />'">删除</a>
									<logic:equal name="base" property="statue" value="0">
										<a href="sealcheckcustom.do?method=download&id=<bean:write name='base' property='id'/>">下载</a>
									</logic:equal>
								</td>
							</tr>
						</logic:iterate>
