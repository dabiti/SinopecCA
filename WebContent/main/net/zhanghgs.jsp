...
<script type="text/javascript"> 
 ...
 $("#account").focus();
   ...
   <c:if  test='${tesyw_shuangrhq==1}'>
	   ...
	   if(accountstate.indexOf('有效')==-1){alert('账户状态为：'+accountstate+',无法挂失');return};
	   if (confirm("确定要挂失?"))
	   {
			   var obj = new Object(); 
			   obj.titleName = "挂失";
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td background="images/main_place_bg.gif">特殊业务 - 账户挂失</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<form id="form1" name="form1"  method="post" action="accountinfo.do?method=zhanghgs">    
    ...
    <td>
      <table width="100%"  border="0" cellspacing="1" cellpadding="0" class="class1_table">
        <thead class="class1_thead">
          <tr>
            <th colspan="2" class="class1_thead th">账户挂失</th>
          </tr>
        </thead>
		<tr>
          ...
          <td width="58%" class="class1_td alignleft">
          	<input id="account" name="account" type="text"
          	 onkeydown='if(event.keyCode==13){startRequestForNet(this)}'
          	 maxlength="25"  class="inputField required account" style="width:140px;"  />
          &nbsp;
...
<div class="funbutton">
  <button type="submit" style="width:60px" onmouseover="this.className='buttom2'" onmouseout="this.className='buttom1'" class="buttom2">账户挂失</button>
  &nbsp;&nbsp;&nbsp;
