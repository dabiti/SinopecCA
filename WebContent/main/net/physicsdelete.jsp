...
<html>
 ...
 $("#account").focus();
   ...
   <c:if  test='${tesyw_shuangrhq==1}'>
	   ...
	   if (confirm("确定要物理删除此账户？"))
	   {
		   var obj = new Object(); 
		   obj.titleName = "物理删除帐户";
   ...
   <c:if test='${tesyw_shuangrhq!=1}'>
	...
	<body onkeydown='if(event.keyCode==78&&event.ctrlKey)return false;'>
		...
		<form id="form1" name="form1" method="post"
			action="accountinfo.do?method=physicsDeleteForNet">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="0"
							...
							<tr>
								<td width="45%" class="class1_td alignright">
									账号								</td>
								<td width="55%" class="class1_td alignleft">	<input type="text" name="account" id="account"
										onkeydown='if(event.keyCode==13){startRequestForNet(this)}'
										id="account"
										class="inputField required account" />
								&nbsp;							
							...
							<tr>
								...
								<td id="accountname" class="class1_td alignleft">&nbsp;
							...
							<tr>
								...
								<td id="allexchange" class="class1_td alignleft">&nbsp;
							...
							<tr>
								...
								<td id="englishname" class="class1_td alignleft">&nbsp;
			...
			<div class="funbutton">
				...
				&nbsp;&nbsp;&nbsp;
				<button type="reset" style="width: 60px"
					onmouseover="this.className='buttom2'"
					onmouseout="this.className='buttom1'" class="buttom1"
					onclick="resetInfo(this)">
