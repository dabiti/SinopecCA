...
<script type="text/javascript"> 
 ...
 $("#account").focus();
   ...
   <c:if  test='${tesyw_shuangrhq==1}'>
	   ...
	   if(accountstate.indexOf('挂失')==-1){alert('账户状态为：'+accountstate+',无法销户恢复');return};
	   if (confirm("确定要解挂账户？"))
	   {
		   var obj = new Object(); 
		   obj.titleName = "解挂账户";
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td background="images/main_place_bg.gif">特殊业务 - 账户解挂</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<form id="form1" name="form1"  method="post" action="accountinfo.do?method=jiegAccountForNet">    
    ...
    <td>
      <table width="100%"  border="0" cellspacing="1" cellpadding="0" class="class1_table">
        <thead class="class1_thead">
          <tr>
            <th colspan="2" class="class1_thead th">账户解挂</th>
          </tr>
        </thead>
		<tr>
          ...
          &nbsp;
          <button type="button" style="width:60px" onmouseover="this.className='buttom2'" onmouseout="this.className='buttom1'" class="buttom1" onclick="startRequestForNet(this)" >
					查询
		  </button> 
          </td>
        </tr>
