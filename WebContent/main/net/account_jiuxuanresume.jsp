...
function getAccountInfo() {
 ...
 $("#zhangh").focus();
   ...
   submitHandler:function(form){
	   ...
	   if(accountstate.indexOf('久悬')==-1){alert('账户状态为：'+accountstate+',无法转为有效');return};
	 //  if (confirm("确定要将账户转为有效状态?"))
	 //  {	   
   <c:if  test='${tesyw_shuangrhq==1}'>
			   var obj = new Object(); 
			   obj.titleName = "久悬恢复";
			   obj.account = $("#zhangh").val();obj.checktype="授权";obj.quanxbs="JXHF_001";
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td background="images/main_place_bg.gif">特殊业务 - 久悬账户转正常</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<form id="form1" name="form1"  method="post" action="accountinfo.do?method=AccountToNormal">    
    ...
    <td>
      <table width="100%"  border="0" cellspacing="1" cellpadding="0" class="class1_table">
        <thead class="class1_thead">
          <tr>
            <th colspan="2" class="class1_thead th">久悬账户转正常</th>
          </tr>
        </thead>
		<tr>
...
<div class="funbutton">
  <button type="submit" style="width:60px" onmouseover="this.className='buttom2'" onmouseout="this.className='buttom1'" class="buttom2">转正常户</button>
  &nbsp;&nbsp;&nbsp;
