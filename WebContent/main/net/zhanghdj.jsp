...
<script type="text/javascript"> 
 ...
 $("#account").focus();
   ...
   <c:if  test='${tesyw_shuangrhq==1}'>
	   ...
	   if(accountstate.indexOf('有效')==-1){alert('账户状态为：'+accountstate+',无法冻结');return};
	   if (confirm("确定要冻结账户?"))
	   {
			   var obj = new Object(); 
			   obj.titleName = "冻结";
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td background="images/main_place_bg.gif">特殊业务 - 账户冻结</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<form id="form1" name="form1"  method="post" action="accountinfo.do?method=zhanghdj">    
    ...
    <td>
      <table width="100%"  border="0" cellspacing="1" cellpadding="0" class="class1_table">
        <thead class="class1_thead">
          <tr>
            <th colspan="2" class="class1_thead th">账户冻结</th>
          </tr>
        </thead>
		<tr>
...
<div class="funbutton">
  <button type="submit" style="width:60px" onmouseover="this.className='buttom2'" onmouseout="this.className='buttom1'" class="buttom2">账户冻结</button>
  &nbsp;&nbsp;&nbsp;
