...
function WebFXLoadTree(sText, sXmlSrc, sAction, sTarget, sBehavior, sIcon, sOpenIcon) {
	// call super
...
function _startLoadXmlTree(sSrc, jsNode) {
	...
	jsNode.loading = true;
	var rr = Math.random();
	var src = sSrc+"&rrrr="+rr;
	var xmlHttp = XmlHttp.create();
	xmlHttp.open("GET", src, true);	// async
...
function _xmlTreeToJsTree(oNode) {
	...
	var checkflag = oNode.getAttribute("checkflag");
	...
	if(checkflag != "")
	{
	    jsNode.checkflag = checkflag;
	    jsNode.checkvalue = checkvalue;
    }
